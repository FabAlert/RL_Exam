...
void NAVIGATION::human_input(){
	...
	if( keyboard_input == "1") {  //1 room
		_requested_marker = 77;
		_kukamark=24;
	} 
		
	else if( keyboard_input == "2") { //2 room
		_requested_marker = 11;
		_kukamark=25;
	}
...
void NAVIGATION::ctrl_loop(){
    ...
    room1.x = -2.7; room1.y = -3.3;
	room2.x = 3.0; room2.y = -2.1;
	room3.x = 3.1; room3.y = 3.4;
	room4.x = -3.64; 	room4.y = 3.99;
